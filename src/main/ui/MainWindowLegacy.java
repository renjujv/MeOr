...
class MainWindowLegacy extends JFrame{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable() {
			public void run()
			{//exception handling for MainWindowLegacy
				try {
					MainWindowLegacy GUI = new MainWindowLegacy();
					GUI.setVisible(true);
				} catch (Exception e) {
	...
	//Constructor
	MainWindowLegacy() throws Exception{

		try {
			setIconImage(Toolkit.getDefaultToolkit().getImage(MainWindowLegacy.class.getResource(windowicon)));
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	...
	private void setMenuBar(){
		...
		lblSearch.setIcon(new ImageIcon(MainWindowLegacy.class.getResource("/resources/search.png")));
